...
void encodeDFA(jbyte *buf, size_t size, const libalf::finite_automaton &fa)
{
	ArraySink snk(buf, size);

	writeDFA(snk, fa);
}

void encodeNFA(jbyte *buf, size_t size, const libalf::finite_automaton &fa)
{
	ArraySink snk(buf, size);
